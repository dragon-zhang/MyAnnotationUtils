 ...
 *
 * <ul>
 * <li>Explicit and Implicit {@link MyAliasFor @AliasFor} declarations on one or
 * more attributes within the annotation</li>
 * <li>Explicit {@link MyAliasFor @AliasFor} declarations for a meta-annotation</li>
 ...
 * </table>
 *
 * <p>{@link MyMergedAnnotations} can be obtained {@linkplain #from(AnnotatedElement)
 ...
 *
 * <p>From a {@link MyMergedAnnotations} instance you can either
 ...
 * @see MyAliasFors
 */
public interface MyMergedAnnotations extends Iterable<MergedAnnotation<Annotation>> {
	...
	/**
	 * Create a new {@link MyMergedAnnotations} instance containing all
	 ...
	 * @return a {@link MyMergedAnnotations} instance containing the element's
	 * annotations
	 */
	static MyMergedAnnotations from(AnnotatedElement element) {
	 ...
	 * @return a {@link MyMergedAnnotations} instance containing the merged
	 * element annotations
	 */
	static MyMergedAnnotations from(AnnotatedElement element, SearchStrategy searchStrategy) {
	...
	/**
	 * Create a new {@link MyMergedAnnotations} instance from the specified
	 * annotations.
	 * @param annotations the annotations to include
	 * @return a {@link MyMergedAnnotations} instance containing the annotations
	 * @see #from(Object, Annotation...)
	 */
	static MyMergedAnnotations from(Annotation... annotations) {
	 ...
	 */
	static MyMergedAnnotations from(Object source, Annotation... annotations) {
	 ...
	 * @return a {@link MyMergedAnnotations} instance containing the annotations
	 */
	static MyMergedAnnotations from(Object source, Annotation[] annotations, RepeatableContainers repeatableContainers) {
	 ...
	 * element annotations
	 */
	static MyMergedAnnotations fromMultipleAliasesAnnotations(AnnotatedElement element, SearchStrategy searchStrategy,
															  RepeatableContainers repeatableContainers) {
		Assert.notNull(repeatableContainers, "RepeatableContainers must not be null");
	 ...
	 * {@link MyMergedAnnotations} instance to be created from annotations that
	 ...
	 * index} of {@code 0}.
	 * <p>The resulting {@link MyMergedAnnotations} instance will contain both the
	 ...
	 */
	static MyMergedAnnotations of(Collection<MergedAnnotation<?>> annotations) {
	 ...
	 * {@link MyMergedAnnotations#from(AnnotatedElement, SearchStrategy)}.
	 *
	 * <p>Each strategy creates a different set of aggregates that will be
	 * combined to create the final {@link MyMergedAnnotations}.
	 */
	enum SearchStrategy {
